...
async def initialize_mega_projects():
    ...
    async with pool.acquire() as conn:
        ...
        projects = [
            ('Global Trade Network', 'Establishes international trade routes for all corporation members', 1000000000, 'income_boost', 15.0),
            ('Tax Haven Initiative', 'Reduces stock trading taxes for all corporation members', 2000000000, 'tax_reduction', 50.0),
            ('Advanced R&D Facility', 'Boosts company income generation for all members', 3000000000, 'company_income', 20.0),
            ('Market Intelligence Center', 'Provides market insights and reduced trading fees', 2500000000, 'trading_bonus', 10.0),
            ('Corporate University', 'Increases efficiency across all member operations', 4000000000, 'global_efficiency', 12.0),
        ]
