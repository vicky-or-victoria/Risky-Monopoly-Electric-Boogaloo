                ...
                try:
                    ...
                    if message_id:
                        try:
                            message = await channel.fetch_message(int(message_id))
                            if chart_file:
                                await message.edit(embed=embed, view=view, attachments=[chart_file])
                            else:
                            ...
                            if chart_file:
                                ...
                                message = await channel.send(embed=embed, view=view, file=discord.File(chart_file.fp, filename='stock_chart.png'))
                            else:
